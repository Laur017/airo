...
const Map = ({ locations, data }: MapProps) => {
	...
	const defaultIcon = L.divIcon({
        ...
        <path fill="url(#marker-gradient)" fill-opacity=".8" fill-rule="evenodd" clip-rule="evenodd" d="M18 52C18 52 36 34.8302 36 18.1509C36 8.12645 27.9411 0 18 0C8.05887 0 0 8.12645 0 18.1509C0 34.8302 18 52 18 52ZM18 30C24.6274 30 30 24.6274 30 18C30 11.3726 24.6274 6 18 6C11.3726 6 6 11.3726 6 18C6 24.6274 11.3726 30 18 30Z" /> 
        <circle cx="18" cy="18" r="12" fill="#FFFFFF" fill-opacity="0.7"/> 
        <text x="18" y="18" fill="#000000" font-size="10" font-weight="600" text-anchor="middle" dominant-baseline="middle">${
					defaultVal?.iaqi?.pm10?.v || ''
				}</text> 
        <defs> 
            <linearGradient id="marker-gradient" gradientTransform="rotate(90)"> 
                <stop offset="0%" stop-color="#ACF254" stop-opacity="1" /> 
                <stop offset="100%" stop-color="#20944E" stop-opacity="1" /> 
            </linearGradient> 
        </defs> 
    </svg>`,
		iconSize: [36, 52],
	...
	const generateIconSvg = (pmValue: number, isActive: boolean) => {
		const whiteCircle = isActive
			? `
        <circle cx="10" cy="10" r="6" fill="none" stroke="white" stroke-width="5"/>`
			: '';

		if (pmValue >= 10) {
			return `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ${whiteCircle}
            <circle cx="10" cy="10" r="4" stroke="url(#paint0_linear_1_14989)" stroke-width="4"/>
            <defs>
                <linearGradient id="paint0_linear_1_14989" x1="10" y1="4" x2="10" y2="16" gradientUnits="userSpaceOnUse">
			...
			return `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ${whiteCircle}
            <circle cx="10" cy="10" r="4" stroke="url(#paint0_linear_1_14994)" stroke-width="4"/>
            <defs>
                <linearGradient id="paint0_linear_1_14994" x1="10" y1="4" x2="10" y2="16" gradientUnits="userSpaceOnUse">
			...
			return `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ${whiteCircle}
            <circle cx="10" cy="10" r="4" stroke="url(#paint0_linear_1_14997)" stroke-width="4"/>
            <defs>
                <linearGradient id="paint0_linear_1_14997" x1="10" y1="4" x2="10" y2="16" gradientUnits="userSpaceOnUse">
